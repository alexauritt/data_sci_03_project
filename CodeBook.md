...
Activity
	Category. One of the following 6 activities was measured:
		STANDING
		SITTING
		WALKING
		WALKING_UPSTAIRS
...
TimeDomainSignalGravityAccelerometerStandardDeviationOnYAxisAverage
	Decimal value normalized and bounded within [-1,1]	Decimal value normalized and bounded within [-1,1]
	Average of all observations of corresponding feature for the given volunteer and for the specified activity.
